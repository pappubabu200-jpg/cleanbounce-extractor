    ...
    <div class="section-block output-wrapper">
        <div class="section-header">
            ...
            <div class="output-actions">
                <button class="icon-btn" onclick="selectAllOutput()" title="Select All">Select</button>
                <button class="icon-btn" onclick="clearOutput()" title="Clear">Clear</button>
            </div>
        </div>
...
function setProgress(percent) {
    ...
    if (percent >= 100) {
        setTimeout(function() { bar.classList.remove('active'); }, 500);
    }
}
